...
const MIGRATED_PAGE_PATHS = ['/transfer', '/settings', '/notifications', '/gelco-docs', '/stock', '/stocks', '/', '/requests', '/inward', '/login', '/outward', '/reports', '/reports/search', '/reports/analytics', '/reports/alerts', '/reports/daily', '/favicon.ico'];
